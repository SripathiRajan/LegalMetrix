...
class PDFReportGenerator:
    ...
    def generate_report(
        ...
        # 6. Official Legal Disclaimer (Exact match to project documentation)
        elements.append(KeepTogether([
            HRFlowable(width="100%", thickness=0.75, color=colors.HexColor("#94A3B8"), spaceAfter=6),
            Paragraph(
                "<b>Important Legal Disclaimer:</b> Readability metrics and optical detections are automated screening estimates "
                "based on image resolution and pixel height. They do <b>not</b> represent statutory physical millimeter measurements "
                "under the Legal Metrology Act, 2009 / Legal Metrology (Packaged Commodities) Rules, 2011.",
                disclaimer_style
            ),
            Spacer(1, 3),
            Paragraph(
                "This assessment is generated by an automated Legal Metrology compliance rule engine for pre-screening and audit inspection "
                "assistance and does not constitute a final legal certification under the Legal Metrology Act, 2009.",
                disclaimer_style
            )
        ]))
