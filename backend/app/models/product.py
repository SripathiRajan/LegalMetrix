...
class ComplianceResponse(BaseModel):
    ...
    disclaimer: str = Field(
        default="This assessment is generated by an automated Legal Metrology compliance rule engine for pre-screening purposes and does not constitute a final legal certification under the Legal Metrology Act, 2009 / LMPC Rules, 2011.",
        description="Legal disclaimer regarding rule-engine automation"
    )
